            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label>
                  ...
                  Fitness <small>- ₱750 per month</small></label>
                <label>
                  <input type="radio" value="Sauna" name="services" />
                  Sauna <small>- ₱900 per month</small></label>
                <label>
                  <input type="radio" value="Cardio" name="services" />
                  Cardio <small>- ₱650 per month</small></label>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <div class="input-append">
                  ...
                  <input type="number" placeholder="Input Exact Ammount." name="amount" class="span11">
                  </div>
              </div>
            </div>
