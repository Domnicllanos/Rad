                                            ...
                                            <tr>
                                                <td class="content-block">
                                                    <table class="invoice">
                                                        <tbody>
                                                        <tr>
                                                            <td><div style="float:left">Invoice #GMS_<?php echo(rand(100000,10000000));?> <br>PRK.1 <br>TOMAS CABILI </div><div style="float:right"> Last Payment: <?php echo $paid_date?></div></td>
                                                        </tr>
