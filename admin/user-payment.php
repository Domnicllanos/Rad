...
<div id="header">
  <h1><a href="">RAD FITNESS GYM ILIGAN</a></h1>
</div>
              ...
              <div class="span5">
                <table class="">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td><h4>RAD FITNESS GYM ILIGAN</h4></td>
                    </tr>
                    <tr>
                      <td>PRK. TOMAS CABILI</td>
                    </tr>
                    ...
                    <tr>
                      <td >Email: support@RADFITNESSGYMILIGAN.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
                ...
                <table class="table table-bordered table-invoice">
				  ...
				  <form action="userpay.php" method="POST">
                    ...
                    <tr>
                      ...
                      <td><input id="amount" type="number" name="amount" placeholder="Input Exact Amount" value='<?php if($row['services'] == 'Fitness') { echo '55';} elseif ($row['services'] == 'Sauna') { echo '';} else {echo '40';} ?>' /></td>
                    </tr>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date("Y");?></a> </div>
</div>
